...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.SubtitleLabel_6.setText(
            _translate(
                "Form", "一行一个QQ号，填写在这个列表中的QQ号的消息不会被任何模块处理"
            )
        )
        self.SubtitleLabel_9.setText(
            _translate("Form", "请勿填写 QQ机器人 自己的QQ号！！！")
        )
